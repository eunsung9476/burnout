import{r as d,j as e,L as v}from"./index-o89flrOM.js";import{u as N,g as y}from"./school-data.functions-DjB0UiHX.js";const k=`
.landing{
...
`;function C(){const{data:r}=N({queryKey:["school-data"],queryFn:()=>y()}),t=r?.schools??[],s=r?.ok??!1,i=t.length,g=new Set(t.map(o=>o.시도)).size,x=t.filter(o=>o.과밀등급==="TOP1"||o.소멸등급==="TOP1"||o.기간제등급==="TOP1").length,[m,p]=d.useState(!1);return e.jsxs("div",{className:"landing",children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:k}}),e.jsxs("nav",{children:[e.jsxs("a",{className:"nav-logo",href:"#top",children:[e.jsx("span",{className:"dot"}),"교사번아웃리스크"]}),e.jsxs("ul",{className:"nav-links",children:[e.jsx("li",{children:e.jsx("a",{href:"#facts",children:"주요 통계"})}),e.jsx("li",{children:e.jsx("a",{href:"#news",children:"관련 뉴스"})}),e.jsx("li",{children:e.jsx("a",{href:"#features",children:"분석 기능"})})]}),e.jsxs("div",{className:"nav-cta",children:[e.jsx("button",{className:"btn-sub",onClick:()=>p(!0),children:"📬 위험 알림 구독"}),e.jsx(v,{className:"btn-go",to:"/dashboard",children:"대시보드 열기 →"})]})]}),e.jsxs("section",{className:"hero",id:"top",children:[e.jsxs("div",{className:"hero-left",children:[e.jsx("span",{className:"badge",children:"실시간 분석 플랫폼"}),e.jsxs("h1",{className:"hero-title",children:["전국 ",i>0?i.toLocaleString():"10,000+","개교",e.jsx("br",{}),"교사 번아웃",e.jsx("br",{}),e.jsx("em",{children:"위험 지도"})]}),e.jsx("p",{className:"hero-desc",children:"과밀학급·학교소멸·기간제교원 비율을 종합 분석하여 교사 번아웃 고위험 학교를 조기에 식별하고 체계적인 지원 근거를 제공합니다."}),e.jsx("div",{className:`status-banner ${s?"status-ok show":"show"}`,children:s?`✅ 데이터 연결됨 — 전국 ${i.toLocaleString()}개 학교 분석 준비 완료`:`⚠️ ${r?.error??"데이터를 확인하는 중..."} (data/ 폴더에 파일을 넣어주세요)`}),e.jsxs("div",{className:"hero-stats",children:[e.jsxs("div",{className:"stat-item",children:[e.jsx("span",{className:"stat-num",children:"76%"}),e.jsx("span",{className:"stat-label",children:"번아웃 경험 교사"})]}),e.jsxs("div",{className:"stat-item",children:[e.jsx("span",{className:"stat-num yellow",children:"30%"}),e.jsx("span",{className:"stat-label",children:"심각한 소진 호소"})]}),e.jsxs("div",{className:"stat-item",children:[e.jsx("span",{className:"stat-num blue",children:"68%"}),e.jsx("span",{className:"stat-label",children:"언어폭력 피해 경험"})]})]}),e.jsxs("div",{className:"hero-actions",children:[e.jsx(v,{className:"btn-primary",to:"/dashboard",children:"📊 대시보드 바로가기"}),e.jsx("a",{className:"btn-secondary",href:"#facts",children:"관련 현황 보기"})]})]}),e.jsx("div",{className:"hero-right",children:e.jsx(z,{schools:t,total:i,top1:x,ok:s})})]}),e.jsxs("section",{className:"facts-sec",id:"facts",children:[e.jsxs("div",{className:"facts-header",children:[e.jsxs("div",{children:[e.jsx("div",{className:"sec-label",children:"핵심 통계"}),e.jsxs("h2",{className:"sec-title",children:["지금 학교에서",e.jsx("br",{}),"무슨 일이 벌어지고 있나"]})]}),e.jsxs("p",{className:"sec-sub",children:["2024년 전교조·녹색병원 공동 조사,",e.jsx("br",{}),"교사 1,964명 응답 분석 결과입니다."]})]}),e.jsxs("div",{className:"facts-grid",children:[e.jsx(b,{num:"76",sup:"%",title:"번아웃 경험 교사",desc:"조사 대상 교사 1,964명 중 76.1%가 업무로 인한 소진 상태를 경험한 것으로 나타났습니다."}),e.jsx(b,{num:"43",sup:"%",title:"심한 우울증상 교사",desc:"CESD 기준 심한 우울증상(definite)이 확인된 교사 비율. 경도 우울 포함 시 67.3%."}),e.jsx(b,{num:"68",sup:"%",title:"언어폭력 피해 교사",desc:"지난 1년간 언어폭력을 경험했다고 응답한 교사 비율. 일반 노동자 대비 10배 이상."}),e.jsx(b,{num:"39",sup:"%",title:"학부모 민원 스트레스",desc:"직무 스트레스 중 학부모 상담·민원 대응이 가장 높은 순위(38.8%)를 차지."})]}),e.jsxs("div",{className:"live-stats",children:[e.jsxs("div",{className:"live-card",children:[e.jsx("div",{className:"live-num",children:s?i.toLocaleString():"—"}),e.jsx("div",{className:"live-label",children:"분석 대상 전체 학교"})]}),e.jsxs("div",{className:"live-card",children:[e.jsx("div",{className:"live-num",children:s?i.toLocaleString():"—"}),e.jsx("div",{className:"live-label",children:"TOP5 위험등급 학교"})]}),e.jsxs("div",{className:"live-card",children:[e.jsx("div",{className:"live-num",children:s?g:"—"}),e.jsx("div",{className:"live-label",children:"분석 시도 수"})]})]})]}),e.jsxs("section",{className:"news-sec",id:"news",children:[e.jsx("div",{className:"sec-label",children:"관련 뉴스 & 연구"}),e.jsxs("h2",{className:"sec-title",children:["교사 번아웃,",e.jsx("br",{}),"지금 이렇게 보도되고 있습니다"]}),e.jsxs("div",{className:"news-grid",children:[e.jsxs("a",{className:"news-main",href:"https://www.edpl.co.kr",target:"_blank",rel:"noreferrer",children:[e.jsxs("div",{className:"news-img",children:[e.jsx("span",{className:"news-tag",children:"📰 교육플러스 | 2024.09.04"}),e.jsx("div",{className:"news-bars",children:[40,65,50,80,72].map((o,n)=>e.jsx("div",{className:"bar",style:{height:`${o}%`,animationDelay:`${n*.1}s`}},n))}),e.jsx("span",{className:"big76",children:"76"})]}),e.jsxs("div",{className:"news-body",children:[e.jsx("div",{className:"news-src",children:"교육플러스 | 이재익 기자 | 2024.09.04"}),e.jsx("h3",{className:"news-ttl",children:'"교사 76% 번아웃 경험"…전교조, 교사 마음 건강 실태조사 결과 발표'}),e.jsx("p",{children:"전교조와 녹색병원이 교사 1,964명을 대상으로 실시한 조사에서 76.1%가 번아웃을 경험했으며, 30.4%는 업무 수행이 어려울 정도의 심각한 소진 상태인 것으로 나타났습니다."}),e.jsxs("span",{className:"news-link",children:["기사 원문 보기 ",e.jsx("span",{className:"arrow",children:"→"})]})]})]}),e.jsxs("div",{className:"news-side",children:[e.jsxs("a",{className:"news-sm",href:"#news",children:[e.jsx("div",{className:"news-date",children:"2024.09.04 · 교육플러스"}),e.jsx("div",{className:"news-sm-ttl",children:"20대 교사 번아웃 가장 심각…연령 높아질수록 감소 경향"}),e.jsx("div",{className:"news-sm-desc",children:"유치원·초등 교사에서 소진 경험이 더 많았고, 학부모 상담 횟수가 증가할수록 소진도 비례 증가했습니다."})]}),e.jsxs("a",{className:"news-sm",href:"#news",children:[e.jsx("div",{className:"news-date",children:"2024.09.04 · 교육플러스"}),e.jsx("div",{className:"news-sm-ttl",children:"신체폭력 경험 교사의 45.8%, 외상후 스트레스 고위험군"}),e.jsx("div",{className:"news-sm-desc",children:"언어폭력 경험 교사의 37.6%가 PTSD 고위험군. 2023년 대비 개선되지 않은 것으로 나타났습니다."})]}),e.jsxs("a",{className:"news-sm",href:"#news",children:[e.jsx("div",{className:"news-date",children:"2024.09.04 · 교육플러스"}),e.jsx("div",{className:"news-sm-ttl",children:'전교조 "교사 정신건강, 이미 재난 상황…국가적 대책 필요"'}),e.jsx("div",{className:"news-sm-desc",children:"사회구조적 위협요인이므로 교원지위법 개정, 민원 처리 시스템 안착 등 제도적 개선을 촉구했습니다."})]})]})]})]}),e.jsxs("section",{className:"feat-sec",id:"features",children:[e.jsx("div",{className:"sec-label",children:"분석 기능"}),e.jsxs("h2",{className:"sec-title",children:["대시보드에서",e.jsx("br",{}),"할 수 있는 것들"]}),e.jsx("p",{className:"sec-sub",children:"6개의 분석 탭을 통해 전국 위험 학교를 다각도로 파악하세요."}),e.jsxs("div",{className:"feat-grid",children:[e.jsx(f,{icon:"📊",title:"현황 대시보드",desc:"전국 위험학교 지도, 학교급별 위험 프로파일, TOP10 랭킹. 가중치 조절로 나만의 종합위험지수를 산출하세요.",badge:"탭 1"}),e.jsx(f,{icon:"📈",title:"추이 & 예측",desc:"2020~2024 실제 데이터로 2025~2026년 학생수·교원수를 LinearRegression으로 예측합니다.",badge:"탭 2"}),e.jsx(f,{icon:"🔬",title:"군집 분석",desc:"K-Means로 유사한 위험 패턴의 학교를 자동 군집화해 맞춤형 대응 방안을 도출하세요.",badge:"탭 3"}),e.jsx(f,{icon:"⚖️",title:"학교 비교",desc:"Butterfly Chart로 두 학교를 6개 지표에서 직접 비교합니다.",badge:"탭 4"}),e.jsx(f,{icon:"🧪",title:"임계치 시뮬레이터",desc:"학생수·기간제 비율을 조정해 종합위험지수 변화를 즉시 시뮬레이션합니다.",badge:"탭 5"}),e.jsx(f,{icon:"🗺️",title:"지역 랭킹",desc:"17개 시도 및 행정구별 평균 종합위험지수 랭킹으로 우선 지원 지역을 파악하세요.",badge:"탭 6"})]})]}),e.jsxs("section",{className:"cta-sec",children:[e.jsx("div",{className:"sec-label",style:{justifyContent:"center"},children:"지금 바로 시작하세요"}),e.jsxs("h2",{className:"sec-title",children:["데이터로 교사를",e.jsx("br",{}),"지키는 첫걸음"]}),e.jsx("p",{className:"sec-sub",style:{margin:"0 auto"},children:"전국 초·중·고 데이터 기반 번아웃 위험 지표를 분석 대시보드에서 직접 탐색해보세요."}),e.jsxs("div",{className:"cta-btns",children:[e.jsx(v,{className:"btn-primary btn-lg",to:"/dashboard",children:"📊 분석 대시보드 열기"}),e.jsx("button",{className:"btn-secondary btn-lg",onClick:()=>p(!0),children:"📬 위험 알림 구독하기"})]})]}),e.jsxs("footer",{children:[e.jsxs("div",{className:"f-left",children:[e.jsx("strong",{children:"교사 번아웃 위험학교 분석 플랫폼"}),e.jsx("br",{}),"데이터 출처: 교육부 교육통계서비스 · 전교조 마음 건강 실태조사 2024"]}),e.jsxs("ul",{className:"f-links",children:[e.jsx("li",{children:e.jsx("a",{href:"#facts",children:"통계"})}),e.jsx("li",{children:e.jsx("a",{href:"#news",children:"뉴스"})}),e.jsx("li",{children:e.jsx("a",{href:"#features",children:"기능"})})]})]}),m&&e.jsx(S,{schools:t,onClose:()=>p(!1)})]})}function b({num:r,sup:t,title:s,desc:i}){return e.jsxs("div",{className:"fact-card",children:[e.jsxs("div",{className:"fact-num",children:[r,e.jsx("sup",{children:t})]}),e.jsx("div",{className:"fact-title",children:s}),e.jsx("div",{className:"fact-desc",children:i})]})}function f({icon:r,title:t,desc:s,badge:i}){return e.jsxs("div",{className:"feat-card",children:[e.jsx("div",{className:"feat-icon",children:r}),e.jsx("div",{className:"feat-ttl",children:t}),e.jsx("div",{className:"feat-desc",children:s}),e.jsx("span",{className:"feat-badge",children:i})]})}function z({schools:r,total:t,top1:s,ok:i}){const g=d.useMemo(()=>!i||!r.length?[]:[...r].filter(n=>n.과밀등급==="TOP1"||n.소멸등급==="TOP1"||n.기간제등급==="TOP1").sort((n,a)=>{const c=(Number(n.과밀score)||0)+(Number(n.소멸score)||0)+(Number(n.기간제score)||0);return(Number(a.과밀score)||0)+(Number(a.소멸score)||0)+(Number(a.기간제score)||0)-c}).slice(0,8),[r,i]),x=d.useMemo(()=>{if(!i||!r.length)return[];const n={};return r.forEach(a=>{(a.과밀등급==="TOP1"||a.소멸등급==="TOP1"||a.기간제등급==="TOP1")&&(n[a.학교급]=(n[a.학교급]??0)+1)}),Object.entries(n).sort((a,c)=>c[1]-a[1])},[r,i]),m=d.useMemo(()=>{if(!i||!r.length)return[];const n={};return r.forEach(a=>{(a.과밀등급==="TOP1"||a.소멸등급==="TOP1"||a.기간제등급==="TOP1")&&(n[a.시도]=(n[a.시도]??0)+1)}),Object.entries(n).sort((a,c)=>c[1]-a[1]).slice(0,5)},[r,i]),p=m[0]?.[1]??1,o=d.useMemo(()=>{if(!g.length)return[];const n=g.map(a=>{const c=a.소멸등급==="TOP1"?"소멸위험 TOP1":a.과밀등급==="TOP1"?`교원당 ${Number(a.교원1인당학생수).toFixed(1)}명`:`기간제 ${(Number(a.기간제비율)*100).toFixed(0)}%`;return`${a.시도} ${a.학교명} — ${c}`});return[...n,...n]},[g]);return i?e.jsxs("div",{className:"viz-box",children:[e.jsx("div",{className:"viz-label",children:"위험 현황 분석"}),e.jsx("div",{className:"viz-bars-section",children:x.map(([n,a])=>e.jsxs("div",{className:"viz-bar-row",children:[e.jsx("span",{className:"viz-bar-label",children:n}),e.jsx("div",{className:"viz-bar-track",children:e.jsx("div",{className:"viz-bar-fill",style:{width:`${a/(x[0]?.[1]??1)*100}%`}})}),e.jsx("span",{className:"viz-bar-count",children:a.toLocaleString()})]},n))}),e.jsxs("div",{className:"viz-sido-section",children:[e.jsx("div",{className:"viz-sido-title",children:"시도별 심각 위험학교"}),m.map(([n,a])=>e.jsxs("div",{className:"viz-sido-row",children:[e.jsx("span",{className:"viz-sido-name",children:n}),e.jsx("div",{className:"viz-sido-track",children:e.jsx("div",{className:"viz-sido-fill",style:{width:`${a/p*100}%`}})}),e.jsx("span",{className:"viz-sido-count",children:a})]},n))]}),e.jsxs("div",{className:"viz-metrics",children:[e.jsxs("div",{className:"vm",children:[e.jsx("div",{className:"vm-label",children:"심각 등급 (TOP 1%)"}),e.jsx("div",{className:"vm-val red",children:s.toLocaleString()})]}),e.jsxs("div",{className:"vm",children:[e.jsx("div",{className:"vm-label",children:"분석 대상 학교"}),e.jsx("div",{className:"vm-val blue",children:t.toLocaleString()})]})]}),o.length>0&&e.jsx("div",{className:"ticker-wrap",children:e.jsx("div",{className:"ticker",children:o.map((n,a)=>e.jsxs("span",{className:"ticker-item",children:[e.jsx("span",{className:"dot",children:"●"}),n]},a))})})]}):e.jsxs("div",{className:"viz-box",children:[e.jsx("div",{className:"viz-label",children:"위험 현황 분석"}),e.jsxs("div",{className:"viz-empty",children:[e.jsx("div",{className:"viz-empty-icon",children:"📂"}),e.jsxs("div",{className:"viz-empty-msg",children:["data/ 폴더에 CSV 파일을",e.jsx("br",{}),"넣으면 실제 현황이 표시됩니다"]})]}),e.jsxs("div",{className:"viz-metrics",children:[e.jsxs("div",{className:"vm",children:[e.jsx("div",{className:"vm-label",children:"심각 등급 (TOP 1%)"}),e.jsx("div",{className:"vm-val red",children:"—"})]}),e.jsxs("div",{className:"vm",children:[e.jsx("div",{className:"vm-label",children:"분석 대상 학교"}),e.jsx("div",{className:"vm-val blue",children:"—"})]})]})]})}function S({schools:r,onClose:t}){const[s,i]=d.useState(""),[g,x]=d.useState("전체"),[m,p]=d.useState("전체"),[o,n]=d.useState(70),[a,c]=d.useState(!1),h=d.useRef(null),u=Array.from(new Set(r.map(l=>l.시도).filter(Boolean))).sort();d.useEffect(()=>{const l=w=>w.key==="Escape"&&t();return window.addEventListener("keydown",l),()=>window.removeEventListener("keydown",l)},[t]);const j=()=>{if(!s||!s.includes("@")){h.current&&(h.current.style.borderColor="var(--accent)"),h.current?.focus();return}c(!0)};return e.jsx("div",{className:"overlay on",onClick:t,children:e.jsxs("div",{className:"modal",onClick:l=>l.stopPropagation(),children:[e.jsx("button",{className:"modal-close",onClick:t,children:"✕"}),a?e.jsxs("div",{className:"success-box on",children:[e.jsx("div",{className:"s-icon",children:"✅"}),e.jsx("div",{className:"s-title",children:"구독 완료!"}),e.jsxs("div",{className:"s-desc",children:[s,"으로 알림을 발송합니다.",e.jsx("br",{}),"📍 ",g," · ",m," | ⚠️ 임계치 ",o,"점 이상"]}),e.jsx("button",{className:"btn-submit",style:{marginTop:24},onClick:t,children:"확인"})]}):e.jsxs("div",{children:[e.jsx("div",{className:"modal-title",children:"위험 알림 구독"}),e.jsx("div",{className:"modal-desc",children:"관심 지역 번아웃 위험학교 변동 정보를 이메일로 받아보세요."}),e.jsxs("div",{className:"fg",children:[e.jsx("label",{className:"fl",children:"이메일 주소"}),e.jsx("input",{ref:h,className:"fi",type:"email",placeholder:"example@email.com",value:s,onChange:l=>i(l.target.value)})]}),e.jsxs("div",{className:"fr",children:[e.jsxs("div",{className:"fg",children:[e.jsx("label",{className:"fl",children:"관심 지역"}),e.jsxs("select",{className:"fs",value:g,onChange:l=>x(l.target.value),children:[e.jsx("option",{children:"전체"}),u.map(l=>e.jsx("option",{children:l},l))]})]}),e.jsxs("div",{className:"fg",children:[e.jsx("label",{className:"fl",children:"위험 등급"}),e.jsxs("select",{className:"fs",value:m,onChange:l=>p(l.target.value),children:[e.jsx("option",{children:"전체"}),e.jsx("option",{children:"심각 (상위 1%)"}),e.jsx("option",{children:"경고 (상위 3%)"}),e.jsx("option",{children:"주의 (상위 5%)"})]})]})]}),e.jsxs("div",{className:"rg",children:[e.jsxs("div",{className:"rl",children:[e.jsx("span",{children:"위험지수 임계치"}),e.jsxs("span",{className:"rv",children:[o,"점"]})]}),e.jsx("input",{type:"range",min:0,max:100,value:o,style:{"--pct":`${o}%`},onChange:l=>n(Number(l.target.value))}),e.jsxs("div",{className:"rl",style:{color:"var(--text-dim)",fontSize:".7rem"},children:[e.jsx("span",{children:"0점 (모든 학교)"}),e.jsx("span",{children:"100점 (최고 위험만)"})]})]}),e.jsxs("div",{className:"notify-row",children:[e.jsx("div",{className:"notify-icon",children:"🔔"}),e.jsxs("div",{className:"notify-txt",children:[e.jsx("strong",{children:"임계치 초과 즉시 알림"})," + 주간 요약 리포트를 이메일로 받게 됩니다."]})]}),e.jsx("button",{className:"btn-submit",onClick:j,children:"📬 구독 신청하기"})]})]})})}export{C as component};
